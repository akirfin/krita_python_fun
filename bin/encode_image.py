...
def image_scale_to_width(img_path, width):
...
if __name__ == '__main__':
    img_tag = image_scale_to_width(r"D:\projects\krita_python_fun\pykrita\arc_welding_tool\resources\title_image.jpg", 577)
    print(img_tag)

    # img_tag = image_scale_to_width(r"D:\projects\krita_python_fun\pykrita\camera_layer\resources\title_image.jpg", 577)
    # print(img_tag)

    # img_tag = image_scale_to_width(r"D:\projects\krita_python_fun\pykrita\fetch_gallery\resources\title_image.jpg", 577)
    # print(img_tag)
