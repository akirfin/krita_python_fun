...
if __name__ == "__main__":
    ...
    for entry in ("arc_welding_tool", "camera_layer", "fetch_gallery", "layer_extra_properties"):
    ...
    for entry in ("arc_welding_tool.desktop", "camera_layer.desktop", "fetch_gallery.desktop", "layer_extra_properties.desktop"):
